...
void static_local_example() {
    static int ad {5000};      // local to static_local_example static - retains it value between calls
    cout << "\nLocal static  num is: " << ad << " in static_local_example - start" << endl;
    ad += 1000;
    cout << "Local static  num is: " << ad << " in static_local_example - end" << endl;
}
